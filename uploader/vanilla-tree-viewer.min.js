 ...
 * Original file: /gh/abhchand/vanilla-tree-viewer@2.1.1/dist/index.js
 *
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
var VanillaTreeViewer = (function (e) {
  var t = {};
  function n(r) {
  ...
  function (e, t) {
    ...
    function r(e) {
      return (
        ...
        Object.getOwnPropertyNames(e).forEach(function (t) {
          var n = e[t];
          "object" != typeof n || Object.isFrozen(n) || r(n);
        }),
        e
      );
    }
    ...
    const E =
      ...
      k = function (e, t, n = {}) {
        const r = o({ scope: "comment", begin: e, end: t, contains: [] }, n);
        r.contains.push({
          scope: "doctag",
      ...
      S = k("/\\*", "\\*/"),
      M = k("#", "$"),
      A = { scope: "number", begin: "\\b\\d+(\\.\\d+)?", relevance: 0 },
      C = { scope: "number", begin: E, relevance: 0 },
      T = { scope: "number", begin: "\\b(0b[01]+)", relevance: 0 },
      R = {
        begin: /(?=\/[^/\n]*\/)/,
        contains: [
          {
      ...
      D = { scope: "title", begin: "[a-zA-Z]\\w*", relevance: 0 },
    ...
    const q = {},
      ...
      Q = new Error();
    function X(e, t, { key: n }) {
      let r = 0;
      const a = e[n],
        i = {},
        s = {};
      for (let e = 1; e <= t.length; e++)
        (s[e + r] = a[e]), (i[e + r] = !0), (r += _(t[e - 1]));
        ...
        (function (e) {
          if (Array.isArray(e.begin)) {
            ...
            if ("object" != typeof e.beginScope || null === e.beginScope)
              throw (G("beginScope must be object"), Q);
            X(e, e.begin, { key: "beginScope" }),
              (e.begin = v(e.begin, { joinWith: "" }));
          }
        })(e),
        (function (e) {
          if (Array.isArray(e.end)) {
            ...
            if ("object" != typeof e.endScope || null === e.endScope)
              throw (G("endScope must be object"), Q);
            X(e, e.end, { key: "endScope" }),
              (e.end = v(e.end, { joinWith: "" }));
          }
        })(e);
    }
    function Y(e) {
      ...
      class n {
        ...
        compile() {
          ...
          (this.matcherRe = t(v(e, { joinWith: "|" }), !0)),
            (this.lastIndex = 0);
        }
        exec(e) {
        ...
        (function n(a, i) {
          ...
          return (
            ...
            i &&
              ...
              (s.terminatorEnd = g(s.end) || ""),
              a.endsWithParent &&
                i.terminatorEnd &&
                (s.terminatorEnd += (a.end ? "|" : "") + i.terminatorEnd)),
    ...
    var ae = (function (e) {
      ...
      function g(e, t, n) {
        ...
        const s = i.result ? i.result : _(i.language, i.code, n);
        return (s.code = i.code), O("after:highlight", s), s;
      }
      function _(e, n, r, a) {
        const l = Object.create(null);
        function d() {
          if (!N.keywords) return void O.addText(S);
          let e = 0;
          ...
          for (; t; ) {
            ...
            const a = v.case_insensitive ? t[0].toLowerCase() : t[0],
              i = ((r = a), N.keywords[r]);
            if (i) {
              const [e, r] = i;
              if (
          ...
          null != N.subLanguage
            ? (function () {
                ...
                if ("string" == typeof N.subLanguage) {
                  if (!t[N.subLanguage]) return void O.addText(S);
                  (e = _(N.subLanguage, S, !0, k[N.subLanguage])),
                    (k[N.subLanguage] = e._top);
                } else e = y(S, N.subLanguage.length ? N.subLanguage : null);
                N.relevance > 0 && (M += e.relevance),
        ...
        function p(e, t) {
          return (
            e.scope &&
              ...
              O.openNode(v.classNameAliases[e.scope] || e.scope),
            e.beginScope &&
              (e.beginScope._wrap
                ? (O.addKeyword(
                    S,
        ...
        function b(e) {
          return 0 === N.matcher.regexIndex ? ((S += e[0]), 1) : ((T = !0), 0);
        }
        function f(e) {
          const t = e[0],
            r = n.substr(e.index),
          ...
          N.endScope && N.endScope._wrap
            ? (u(), O.addKeyword(t, N.endScope._wrap))
          ...
          return a.starts && p(a.starts, e), s.returnEnd ? 0 : t.length;
        }
        let h = {};
        function m(t, a) {
          const o = a && a[0];
          ...
          if (
            ...
            if (((S += n.slice(a.index, a.index + 1)), !s)) {
          ...
          if (((h = a), "begin" === a.type))
            return (function (e) {
              ...
              for (const n of a)
                if (n && (n(e, r), r.isMatchIgnored)) return b(t);
              return (
                n.skip
                  ? (S += t)
                  : (n.excludeBegin && (S += t),
        ...
        !(function () {
          const e = [];
          for (let t = N; t !== v; t = t.parent) t.scope && e.unshift(t.scope);
        ...
        try {
          for (N.matcher.considerAll(); ; ) {
            ...
            if (!e) break;
            const t = m(n.substring(A, e.index), e);
            A = e.index + t;
          }
          return (
            m(n.substr(A)),
      ...
      function v(e) {
        ...
        const a = t.textContent,
          i = r ? g(a, { language: r, ignoreIllegals: !0 }) : y(a);
        (e.innerHTML = i.value),
          (function (e, t, r) {
            const a = (t && n[t]) || r;
      ...
      function w() {
        ...
        document.querySelectorAll(c.cssSelector).forEach(v);
      }
      function x(e) {
        ...
        Object.assign(e, {
          ...
          registerLanguage: function (n, r) {
            ...
            a.name || (a.name = n),
              ...
              a.aliases && N(a.aliases, { languageName: n });
          },
      ...
      for (const e in B) "object" == typeof B[e] && a(B[e]);
      return Object.assign(e, B), e;
    })({});
    (e.exports = ae), (ae.HighlightJS = ae), (ae.default = ae);
  },
  function (e, t) {
  ...
  function (e, t) {
    e.exports = function (e) {
      const t = e.regex,
        ...
        c = t.optional("[a-zA-Z_]\\w*::") + e.IDENT_RE + "\\s*\\(",
        d = {
          keyword: [
            "asm",
            "auto",
        ...
        u = [o, a, n, e.C_BLOCK_COMMENT_MODE, s, i],
        g = {
          variants: [
            { begin: /=/, end: /;/ },
            { begin: /\(/, end: /\)/ },
            ...
            { relevance: 0, match: /,/ },
            {
              ...
              contains: [
                ...
                a,
                {
                  ...
                  keywords: d,
                  relevance: 0,
                  contains: ["self", n, e.C_BLOCK_COMMENT_MODE, i, s, a],
                },
              ],
            },
            a,
      ...
      return {
        ...
        exports: { preprocessor: o, strings: i, keywords: d },
      };
    };
  },
  function (e, t) {
    e.exports = function (e) {
      const t = e.regex,
        ...
        g = [u, o, a, n, e.C_BLOCK_COMMENT_MODE, s, i],
        p = {
          variants: [
            { begin: /=/, end: /;/ },
            { begin: /\(/, end: /\)/ },
        ...
        b = {
          ...
          contains: [
            ...
            { begin: /::/, relevance: 0 },
            { begin: /:/, endsWithParent: !0, contains: [i, s] },
            { relevance: 0, match: /,/ },
            {
              className: "params",
              begin: /\(/,
  ...
  function (e, t) {
    e.exports = function (e) {
      ...
      const u = {
          variants: [c, l, a, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE],
        },
        g = {
          begin: "<",
          end: ">",
    ...
    var n = "\\.([0-9](_*[0-9])*)",
      ...
      a = {
        ...
        variants: [
          ...
          {
            begin: `\\b0[xX]((${r})\\.?|(${r})?\\.(${r}))[pP][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`,
          },
    ...
    e.exports = function (e) {
      ...
      const t = "[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*",
        n =
          t +
          (function e(t, n, r) {
            return -1 === r ? "" : t.replace(n, (a) => e(t, n, r - 1));
          })("(?:<" + t + "~~~(?:\\s*,\\s*" + t + "~~~)*>)?", /~~~/g, 2),
        r = {
          keyword: [
            "synchronized",
  ...
  function (e, t) {
    ...
    e.exports = function (e) {
      const t = e.regex,
          ...
          isTrulyOpeningTag: (e, t) => {
            ...
            ">" === r &&
              (((e, { after: t }) => {
                ...
                t.ignoreMatch());
            (a = e.input.substr(n).match(/^\s+extends\s+/)) &&
              0 === a.index &&
              t.ignoreMatch();
          },
        },
        ...
        E = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, m, _, y, f];
      h.contains = E.concat({
        begin: /\{/,
        end: /\}/,
        keywords: p,
      ...
      const w = [].concat(v, h.contains),
        x = w.concat([
          { begin: /\(/, end: /\)/, keywords: p, contains: ["self"].concat(w) },
        ]),
        N = {
          className: "params",
          begin: /\(/,
      ...
      var A;
      const C = {
          begin: t.concat(/\./, t.lookahead(t.concat(c, /(?![0-9A-Za-z$_(])/))),
          end: c,
          excludeBegin: !0,
          keywords: "prototype",
          className: "property",
        ...
        R =
          ...
          ")\\s*=>",
        D = {
          match: [/const|var|let/, /\s+/, c, /\s*/, /=\s*/, t.lookahead(R)],
          className: { 1: "keyword", 3: "title.function" },
          contains: [N],
        };
      return {
        ...
        keywords: p,
        exports: { PARAMS_CONTAINS: x, CLASS_REFERENCE: O },
        illegal: /#(?![$_A-z])/,
        contains: [
          ...
          f,
          O,
          { className: "attr", begin: c + t.lookahead(":"), relevance: 0 },
          D,
          {
  ...
  function (e, t) {
    e.exports = function (e) {
      const t = { beginKeywords: ["true", "false", "null"].join(" ") };
      return {
        name: "JSON",
        contains: [
          {
        ...
        g = {
          ...
          variants: [
            { className: "", begin: /\(\s*\)/, skip: !0 },
            {
              ...
              excludeEnd: !0,
              keywords: r,
              contains: ["self", a, d, o, e.HASH_COMMENT_MODE],
            },
          ],
        };
      return (
    ...
    e.exports = function (e) {
      ...
      return {
        ...
        contains: [
          ...
          {
            begin: e.IDENT_RE + "::",
            keywords: { keyword: "Self", built_in: a },
          },
  ...
  function (e, t) {
    ...
    function d(e) {
      const t = e.regex,
        ...
        h = {
          ...
          variants: [
            {
              begin: `(\\b(0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*)((${f})|\\.)?|(${f}))[eE][+-]?([0-9](_?[0-9])*)\\b`,
            },
            {
              begin: `\\b(0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*)\\b((${f})\\b|\\.)?|(${f})\\b`,
            },
            { begin: "\\b(0|[1-9](_?[0-9])*)n\\b" },
            { begin: "\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b" },
            { begin: "\\b0[bB][0-1](_?[0-1])*n?\\b" },
        ...
        w = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, _, y, v, h];
      m.contains = w.concat({
        begin: /\{/,
        end: /\}/,
        keywords: b,
      ...
      const x = [].concat(E, m.contains),
        N = x.concat([
          { begin: /\(/, end: /\)/, keywords: b, contains: ["self"].concat(x) },
        ]),
        k = {
          className: "params",
          begin: /\(/,
      ...
      const T = {
        ...
        D =
          ...
          ")\\s*=>",
        I = {
          match: [/const|var|let/, /\s+/, d, /\s*/, /=\s*/, t.lookahead(D)],
          className: { 1: "keyword", 3: "title.function" },
          contains: [k],
        };
      return {
        ...
        aliases: ["js", "jsx", "mjs", "cjs"],
        keywords: b,
        exports: { PARAMS_CONTAINS: N, CLASS_REFERENCE: S },
        illegal: /#(?![$_A-z])/,
        contains: [
          e.SHEBANG({ label: "shebang", binary: "node", relevance: 5 }),
          {
          ...
          h,
          S,
          { className: "attr", begin: d + t.lookahead(":"), relevance: 0 },
          I,
          {
            begin: "(" + e.RE_STARTERS_RE + "|\\b(case|return|throw)\\b)\\s*",
            keywords: "return throw case",
            ...
            contains: [
              ...
              { match: /\s+/, relevance: 0 },
              {
                ...
                subLanguage: "xml",
                contains: [
                  { begin: p.begin, end: p.end, skip: !0, contains: ["self"] },
                ],
              },
            ],
          },
    ...
    e.exports = function (e) {
      ...
      return (
        Object.assign(t.keywords, u),
        t.exports.PARAMS_CONTAINS.push(g),
        (t.contains = t.contains.concat([g, s, o])),
  ...
  function (e, t, n) {
    ...
    var l = {};
    n.r(l),
      n.d(l, "render", function () {
        return F;
      });
    var c = {};
    n.r(c),
      n.d(c, "render", function () {
        return Ke;
      });
    var d = {};
    n.r(d),
      ...
      n.d(d, "DEFAULT_MESSAGE", function () {
        return Ze;
      });
    var u = {};
    n.r(u),
      n.d(u, "render", function () {
        return Xe;
      });
    var g = {};
    n.r(g),
      n.d(g, "render", function () {
        return nt;
      });
    var p = n(8),
      b = n.n(p),
      ...
      A =
        ...
        function (e) {
          return "\n    <svg width="
            ...
            .concat(
              e.title || "VanillaTreeViewer Logo",
      ...
      C = function (e) {
        ...
        t.classList.add("vtv__code-panel-action"), t.classList.add("vtv__logo");
      ...
      T =
        ...
        function (e) {
          var t = document.createElement("div");
          return t.classList.add("vtv__code-path"), (t.innerText = e.path), t;
        }),
      R =
        (n(49),
        function (e) {
          var t = e.color || "#000000";
          return "\n  <svg width="
            .concat(e.size || "100px", " height=")
            .concat(
              e.size || "100px",
              ' viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg">\n    <title>Wrap Text</title>\n    <g id="wrap-text-icon" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\n      <path d="M10,25.5 L90,25.5" id="Line" stroke="'
            )
            .concat(
              t,
              '" stroke-width="6" stroke-linecap="round"></path>\n      <path d="M10,48.5 L80,48.5 C88.6666667,49.5 93,53.3333333 93,60 C93,66.6666667 88.6666667,70.6666667 80,72 L65,72" id="Line" stroke="'
            )
            .concat(
              t,
              '" stroke-width="6" stroke-linecap="round"></path>\n      <path d="M10,71.5 L40,71.5" id="Line" stroke="'
            )
            .concat(
              t,
              '" stroke-width="6" stroke-linecap="round"></path>\n      <path d="M62.2275578,62.9615277 L69.2454838,74.9922579 C69.8020444,75.9463618 69.4797719,77.1709972 68.5256681,77.7275578 C68.2197959,77.9059832 67.8720353,78 67.517926,78 L53.482074,78 C52.3775045,78 51.482074,77.1045695 51.482074,76 C51.482074,75.6458907 51.5760908,75.2981301 51.7545162,74.9922579 L58.7724422,62.9615277 C59.3290028,62.0074238 60.5536382,61.6851513 61.5077421,62.2417119 C61.8057493,62.4155495 62.0537202,62.6635204 62.2275578,62.9615277 Z" id="Triangle" fill="'
            )
            .concat(
              t,
              '" transform="translate(60.500000, 69.000000) rotate(30.000000) translate(-60.500000, -69.000000) "></path>\n    </g>\n  </svg>'
            );
        }),
      D = function (e) {
        var t = document.createElement("div");
        t.classList.add("vtv__code-panel-action"),
          t.classList.add("vtv__wrap-text-toggle"),
          e.wrapText && t.classList.add("vtv__code-panel-action--active");
        var n = document.createElement("button");
        return (
          n.addEventListener("click", e.toggleWrapText),
          (n.innerHTML = R({})),
          t.appendChild(n),
          t
        );
    ...
    function B(e) {
      ...
      return !t.includes("prototype") || t.includes("arguments");
    }
    function j(e) {
      var t =
      ...
      return "object" === L()(e) &&
        Object.prototype.hasOwnProperty.call(e, "render")
        ? e.render(t)
        : null;
    }
    var z = function (e) {
        var t = document.createElement("div");
        t.classList.add("vtv__code-panel-header");
        var n = j(a, { path: e.file.path }),
          s = j(i, { wrapText: e.wrapText, toggleWrapText: e.toggleWrapText }),
          o = j(r);
        return t.appendChild(n), t.appendChild(s), t.appendChild(o), t;
      },
      P = n(12),
      $ = n.n(P),
      U =
        ...
        function (e) {
          var t = document.createElement("div");
          return t.classList.add("vtv__code-error"), (t.innerHTML = e.text), t;
        }),
      F =
        (n(53),
        function () {
          ...
          return (
            e.classList.add("vtv__code-loading"),
            (e.innerHTML = "Loading..."),
            e
          );
        }),
          ...
          if ("function" == typeof t) {
            ...
            return r[Symbol.replace].call(this, e, function () {
              ...
              return (
                ...
                "object" !== L()(e[e.length - 1]) && e.push(s(e, i)),
                t.apply(this, e)
              );
            });
          }
    ...
    K.a.registerLanguage("bash", q.a),
      K.a.registerLanguage("c", W.a),
      K.a.registerLanguage("cpp", Q.a),
      K.a.registerLanguage("csharp", J.a),
      K.a.registerLanguage("css", ee.a),
      K.a.registerLanguage("diff", ne.a),
      K.a.registerLanguage("go", ae.a),
      K.a.registerLanguage("java", se.a),
      K.a.registerLanguage("javascript", le.a),
      K.a.registerLanguage("json", de.a),
      K.a.registerLanguage("makefile", ge.a),
      K.a.registerLanguage("xml", be.a),
      K.a.registerLanguage("markdown", he.a),
      K.a.registerLanguage("objectivec", _e.a),
      K.a.registerLanguage("php", ve.a),
      K.a.registerLanguage("php-template", we.a),
      K.a.registerLanguage("plaintext", Ne.a),
      K.a.registerLanguage("python", Oe.a),
      K.a.registerLanguage("ruby", Me.a),
      K.a.registerLanguage("rust", Ce.a),
      K.a.registerLanguage("scss", Re.a),
      K.a.registerLanguage("shell", Ie.a),
      K.a.registerLanguage("sql", Be.a),
      K.a.registerLanguage("typescript", ze.a),
      K.a.registerLanguage("yaml", $e.a);
    var He = (function () {
        function e(t) {
          _()(this, e),
            (this.props = t),
        ...
        return (
          w()(e, [
            ...
            {
              key: "highlightedContents",
              value: function () {
                var e = this.props.file;
                return e.language
                  ? K.a.highlight(e.contents, {
                      language: e.language,
                      ignoreIllegals: !0,
                    }).value
                  : e.contents;
            ...
            },
            {
              ...
              value: function () {
                var e = document.createElement("div");
                e.classList.add("vtv__code"), e.setAttribute("tabindex", "-1");
                var t = document.createElement("style");
                t.innerHTML = this.namespacedCss();
                var n = document.createElement("pre"),
                  r = document.createElement("code");
                return (
                  r.classList.add("hljs"),
                  ...
                  (r.innerHTML = this.highlightedContents()),
                  n.appendChild(r),
                  e.appendChild(n),
                  e.appendChild(t),
                  e
            ...
            },
            {
              ...
              value: function () {
                var e = this.props,
                  t = e.fetchFileContents,
                  n = e.fetchSyntaxHighlightStyle,
                  r = e.file,
                  a = e.syntaxHighlightStyles;
                return r.error
                  ? j(o, { text: r.error })
                  : r.contents
                  ? r.style && !a[r.style]
                    ? (n(r.style, r.path), j(l))
      ...
      Ke = function (e) {
        var t = document.createElement("div");
        t.classList.add("vtv__code-panel");
        var n = j(s, {
            file: e.file,
            wrapText: e.wrapText,
            toggleWrapText: e.toggleWrapText,
          }),
          r = j(He, {
            namespace: e.namespace,
            file: e.file,
            syntaxHighlightStyles: e.syntaxHighlightStyles,
            fetchFileContents: e.fetchFileContents,
            fetchSyntaxHighlightStyle: e.fetchSyntaxHighlightStyle,
            wrapText: e.wrapText,
          });
        return t.appendChild(n), t.appendChild(r), t;
      },
      Ze = (n(54), "There was an error rendering files (see console)."),
      qe = function () {
        var e =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        console.error(
          "vanilla-tree-viewer failed to initialize: ".concat(e.reason)
        );
        var t = document.createElement("div");
        return (
          t.classList.add("vtv"),
          t.classList.add("vtv--invalid"),
          (t.innerText = e.message || Ze),
          t
        );
      },
      Ge =
    ...
    function Xe(e) {
      var t = e.indent,
        ...
        r = function (t) {
          ...
          e.updateSelectedPath(n);
        },
        a = document.createElement("li");
      a.setAttribute("data-path", e.file.path),
        a.setAttribute("style", "padding-left: ".concat(Qe(t), "px;")),
        a.setAttribute("tabindex", "0"),
        a.classList.add("vtv__tree-node", "vtv__tree-node--file"),
        n && a.classList.add("selected"),
        a.addEventListener("click", r),
        a.addEventListener("keydown", function (e) {
          We(e) === Ge.ENTER && r(e);
        });
      var i = Ve({ height: "18px", width: "14px", backgroundColor: "#525154" }),
        s = document.createElement("span");
      return (
        (s.innerHTML = e.file.name), (a.innerHTML = i), a.appendChild(s), a
      );
    }
    var Je = (function () {
        function e(t) {
          ...
          w()(e, [
            {
              ...
              value: function () {
                var e = this.props,
                  t = e.parentPath,
                  n = e.tree;
                return n[t].childPaths.map(function (e) {
                  return n[e];
                });
              },
            },
            ...
            },
            {
              ...
              value: function (e) {
                var t = this.props,
                  n = t.selectedFileId,
                  r = t.updateSelectedPath,
                  a = t.indent;
                return j(u, {
                  file: e,
                  updateSelectedPath: r,
                  isSelected: n === e.id,
                  indent: a,
                });
              },
            },
            {
              ...
              value: function () {
                var e = this,
                  t = [];
                return (
                  this.directories().forEach(function (n) {
                    t = t.concat(e.renderDirectory(n));
                  }),
                  this.files().forEach(function (n) {
                    t.push(e.renderFile(n));
                  }),
                  t
                );
              },
      ...
      Ye = function (e) {
        return "<svg id='folder-closed' width="
          .concat(e.width || "161px", " height=")
          .concat(
            e.height || "130px",
            ' viewBox="0 0 161 130" xmlns="http://www.w3.org/2000/svg" style="min-width:'
          )
          .concat(
            e.width,
            '"><g fill="none" fill-rule="evenodd"><path d="M15 0h41l18 17h72c8.284 0 15 6.716 15 15v83c0 8.284-6.716 15-15 15H15c-8.284 0-15-6.716-15-15V15C0 6.716 6.716 0 15 0z" fill="#FFAF00"/><path d="M15 17h131c8.284 0 15 6.716 15 15v83c0 8.284-6.716 15-15 15H15c-8.284 0-15-6.716-15-15V32c0-8.284 6.716-15 15-15z" fill="#FFD233"/></g></svg>'
          );
      },
      et = function (e) {
        return "<svg id='folder-open' width=\""
          .concat(e.width || "172px", '" height="')
          .concat(
            e.height || "130px",
            '" viewBox="0 0 172 130" xmlns="http://www.w3.org/2000/svg" style="min-width:'
          )
          .concat(
            e.width,
            '"><g fill="none" fill-rule="evenodd"><path d="M15 0h41l18 17h65c8.284 0 15 6.716 15 15v83c0 8.284-6.716 15-15 15H15c-8.284 0-15-6.716-15-15V15C0 6.716 6.716 0 15 0z" fill="#FFAF00"/><path d="M42.968 41H156.26c8.285 0 15 6.716 15 15a15 15 0 0 1-.208 2.493l-9.944 59A15 15 0 0 1 146.317 130H17l11.126-76.168A15 15 0 0 1 42.968 41z" fill="#FFD233"/></g></svg>'
          );
      },
      tt = (function () {
        function e(t) {
          ...
          w()(e, [
            {
              ...
              value: function () {
                var e = this,
                  ...
                  i = function (t) {
                    var n = t.currentTarget.dataset.path;
                    e.props.toggleDirectory(n);
                  },
                  s = document.createElement("li");
                s.setAttribute("data-path", r),
                  (s.style = "padding-left: ".concat(Qe(n), "px;")),
                ...
                var o = (a[r].isOpen ? et : Ye)({
                    height: "18px",
                    width: "24px",
                  }),
                  l = document.createElement("span");
                return (
                  (l.innerHTML = a[r].name),
                  (s.innerHTML = o),
                  s.appendChild(l),
                  s
                );
            ...
            },
            {
              ...
              value: function () {
                var e = this.props,
                  ...
                  a = e.toggleDirectory,
                  i = e.tree,
                  s = e.updateSelectedPath;
                return j(Je, {
                  tree: i,
                  parentPath: i[n].path,
                  indent: t + 1,
                  toggleDirectory: a,
                  updateSelectedPath: s,
                  selectedFileId: r,
                });
              },
            },
            {
              ...
              value: function () {
                var e = this.props,
                  t = e.path,
                  n = e.tree,
                  r = [this.renderDirectory()];
                return n[t].isOpen && (r = r.concat(this.renderContents())), r;
              },
            },
          ]),
          e
      ...
      nt = function (e) {
        ...
        return (
          t.classList.add("vtv__tree"),
          j(tt, {
            tree: e.tree,
            path: "/",
            indent: 0,
            toggleDirectory: e.toggleDirectory,
            updateSelectedPath: e.updateSelectedPath,
            selectedFileId: e.selectedFileId,
          }).forEach(function (e) {
      ...
      rt = n(38),
      at = n.n(rt),
      it = { language: null, style: "monokai-sublime" };
    function st(e, t) {
      var n = Object.keys(e);
    ...
    function lt(e, t, n, r) {
      var a = { id: "".concat(e, "+").concat(n), name: t, type: e, path: n };
      return (
        "directory" === e && ((a.isOpen = !0), (a.childPaths = [])),
        "file" === e &&
          ((a.contents = r.contents || null),
          (a.url = r.url),
          (a.error = null),
    ...
    function dt(e) {
      ...
      return (
        ...
        e.forEach(function (e) {
          t = (function (e, t) {
            var n = ct(t.path).split("/"),
              r = null,
              a = "",
              i = ot(ot({}, it), t);
            return (
              n.forEach(function (t, s) {
                (r = a), (a += 1 === s ? t : "/".concat(t));
                var o = s === n.length - 1 ? "file" : "directory";
                ("directory" === o && e[a]) ||
                  ((e[a] = lt(o, t, a, i)), e[r].childPaths.push(a));
              }),
              e
            );
          })(t, e);
    ...
    var ut = (function () {
              ...
              value: function (e) {
                var t =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : {};
                return Object.prototype.hasOwnProperty.call(this.events, e)
                  ? this.events[e].map(function (e) {
                      return e(t);
                    })
                  : [];
              },
      ...
      gt = (function () {
        function e(t) {
          _()(this, e), (this.state = t.state || {}), (this.events = new ut());
        }
        return (
          w()(e, [
            {
    ...
    var pt = function (e) {
      ...
      ft = function () {
        var e = [];
        return (
          document.querySelectorAll(".vtv").forEach(function (t, n) {
            if (!t.classList.contains("vtv-wrapper")) {
              var r = [],
                a = bt({
                  language: t.dataset.language,
                ...
                e.parentNode === t &&
                  r.push(
                    bt({
                      path: e.dataset.path,
                      url: e.dataset.url,
                      contents: e.innerHTML.trim(),
                      selected:
                        ("string" == typeof e.dataset.selected &&
                          "true" === e.dataset.selected.toLowerCase()) ||
                        null,
                      language: e.dataset.language || a.language,
                      style: e.dataset.style || a.style,
                    })
                  );
              });
              var i = (function (e, t) {
                var n = e.id || "vtv--".concat(t + 1);
                e.classList.add("vtv-wrapper");
    ...
    var ht = function () {
      var e = document.querySelector(".vtv__tree");
      e &&
        document.querySelectorAll(".vtv__tree-node").forEach(function (t) {
          t.style.width = "".concat(e.scrollWidth, "px");
        });
    };
    function mt(e) {
      return (function (e) {
        ...
        ? (function (e) {
          ...
          ? (function (e) {
            ...
            : { isValid: !1, error: "Each `file` must have a non-empty `path`" }
          : { isValid: !1, error: "`files` must contain at least one file" }
        : { isValid: !1, error: "`files` must be an array" };
    }
    function _t(e) {
      var t = (function () {
        if ("undefined" == typeof Reflect || !Reflect.construct) return !1;
    ...
    var yt = (function (e) {
      ...
      function n(e, r) {
        ...
        _()(this, n),
          ...
          (a.toggleDirectory = a.toggleDirectory.bind(v()(a))),
          (a.toggleWrapText = a.toggleWrapText.bind(v()(a))),
          (a.updateSelectedPath = a.updateSelectedPath.bind(v()(a))),
          (a.fetchFileContents = a.fetchFileContents.bind(v()(a))),
          (a.fetchSyntaxHighlightStyle = a.fetchSyntaxHighlightStyle.bind(
            v()(a)
          )),
          (a.renderIntoDOM = a.renderIntoDOM.bind(v()(a))),
          (a.renderComponent = a.renderComponent.bind(v()(a))),
          (a.afterRender = a.afterRender.bind(v()(a))),
          (a.render = a.render.bind(v()(a)));
        var i,
          s,
          o = mt(r);
        return (
          o.isValid && ((i = ct(pt(r))), (s = dt(r))),
          (a.store.state = {
            tree: s,
            selectedPath: i,
        ...
        w()(n, [
          {
            key: "toggleDirectory",
            value: function (e) {
              var t = this.store.state.tree;
              (t[e].isOpen = !t[e].isOpen), this.store.setState({ tree: t });
            },
          },
          {
            key: "toggleWrapText",
            value: function () {
              var e = this.store.state.wrapText;
              this.store.setState({ wrapText: !e });
            },
          },
          {
            key: "updateSelectedPath",
            value: function (e) {
              this.store.setState({ selectedPath: e });
            },
          },
          {
            ...
            value: function (e) {
              ...
              n[e].contents ||
                fetch(r)
                  ...
                  .then(function (r) {
                    (n[e].contents = r), t.store.setState({ tree: n });
                  })
                  .catch(function (a) {
                    (n[e].error = "Could not fetch file contents from ".concat(
                      r
                    )),
                      t.store.setState({ tree: n });
                  });
            },
          },
          {
            key: "fetchSyntaxHighlightStyle",
            value: function (e, t) {
              var n = this,
                r = e.toLowerCase(),
                a = this.store.state,
                i = a.syntaxHighlightStyles,
                s = a.tree;
              if (!Object.prototype.hasOwnProperty.call(i, r)) {
                var o = (function (e) {
                  return "./highlight/styles/"
                    // .concat("11.3.1", "/styles/")
                    .concat(e, ".min.css");
                })(r);
                fetch(o)
                  .then(function (e) {
                  ...
                  .then(function (e) {
                    (i[r] = e), n.store.setState({ syntaxHighlightStyles: i });
                  })
                  .catch(function (e) {
                    (s[t].error =
                      "Could not fetch highlight styling from ".concat(o)),
                      n.store.setState({ tree: s });
                  });
              }
            },
          },
          ...
          },
          {
            ...
            value: function () {
              var e = this.store.state,
                t = e.selectedPath,
                n = e.syntaxHighlightStyles,
                r = e.tree,
                a = e.wrapText,
                i = document.createElement("div");
              i.classList.add("vtv-root");
              var s = j(g, {
                  tree: r,
                  toggleDirectory: this.toggleDirectory,
                  updateSelectedPath: this.updateSelectedPath,
                  selectedFileId: r[t].id,
                }),
                o = j(c, {
                  namespace: this.id,
                  file: r[t],
                  syntaxHighlightStyles: n,
              ...
              return i.appendChild(s), i.appendChild(o), i;
            },
          },
          {
            key: "afterRender",
          ...
          },
          {
            key: "render",
            value: function () {
              var e = this.store.state.errorText,
                t = e ? j(d, { reason: e }) : this.renderComponent();
              this.renderIntoDOM(t), this.afterRender();
            },
          },
        ]),
        n
      ...
      _()(this, e);
      var n = this;
      t.store instanceof gt &&
        ((this.store = t.store),
        this.store.events.subscribe("stateChange", function () {
          return n.render();
        })),
        Object.prototype.hasOwnProperty.call(t, "element") &&
